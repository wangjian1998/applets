...
__DEFINE__(1666066800240, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1666066800241,"./event-store":1666066800242}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1666066800241, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1666066800242, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1666066800241,"./utils":1666066800243}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1666066800243, function(require, module, exports) {
...
return __REQUIRE__(1666066800240);
})()
